...
def parse_tencent_quote_text(text: str, symbol: str) -> dict:
    ...
    支持两种格式：
    1. 短格式（指数 s_ 前缀）：v_s_sh000300="1~沪深 300~000300~4440.79~-38.12~-0.85~..."
       - 字段 4: 涨跌额
       - 字段 5: 涨跌幅%
    2. 长格式（个股/指数）：v_sh600519="51~贵州茅台~600519~1392.00~1459.88~..."
       - 字段 31: 涨跌额
       - 字段 32: 涨跌幅%
    """
    pattern = r'v_(.*?)="(.*?)"'
